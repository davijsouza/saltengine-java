package br.com.saltengine.settings.exception;

import br.com.saltengine.dto.HttpResponseException;
import br.com.saltengine.exception.RegisterException;
import br.com.saltengine.exception.ValidateRegisterException;
...
public class ProjectExceptionsHandler {
    ...
    public ResponseEntity<HttpResponseException> handlerValidateException(ValidateRegisterException ex) {
        return ResponseEntity.badRequest().body(createHttpResponse(ex));
    }

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(value = RegisterException.class)
    public ResponseEntity<HttpResponseException> handlerRegisterException(RegisterException ex) {
        return ResponseEntity.badRequest().body(createHttpResponse(ex));
    }
