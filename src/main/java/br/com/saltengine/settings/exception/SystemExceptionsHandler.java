...
public class SystemExceptionsHandler {
    ...
    public ResponseEntity<HttpResponseException> handlerMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        return ResponseEntity.badRequest().body(createHttpResponse(ex.getBindingResult()));
    }

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(value = BindException.class)
    public ResponseEntity<HttpResponseException> handlerBindException(BindException ex) {
        return ResponseEntity.badRequest().body(createHttpResponse(ex.getBindingResult()));
    }
